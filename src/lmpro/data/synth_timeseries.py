...
class SyntheticTimeSeriesDataset(Dataset):
    ...
    def __init__(self, config: TimeSeriesDatasetConfig, task: str = "forecasting", split: str = "train"):
        self.config = config
        self.task = task
        self.split = split
...
class AnomalyTimeSeriesDataset(Dataset):
    ...
    def __init__(self, config: TimeSeriesDatasetConfig, anomaly_ratio: float = 0.05, split: str = "train"):
        self.config = config
